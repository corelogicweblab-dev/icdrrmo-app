    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link
          ...
          className="rounded-2xl border border-orange-500/15 bg-gradient-to-br from-orange-950/50 to-black/40 p-5 hover:border-orange-500/30 transition-colors"
        >
        ...
        <Link
          href="/responder/map"
          className="rounded-2xl border border-orange-500/15 bg-gradient-to-br from-rose-950/40 to-black/40 p-5 hover:border-rose-500/30 transition-colors flex flex-col"
        >
